...
namespace Thump.Views
{
	public class SettingsView : ThumpView
	{
		...
		public SettingsView(MainView mainView) : base(mainView)
		{
			...
			stack.Children.Add(serverUrlLabel);
			...
			stack.Children.Add(m_serverUrlEntry);
			...
			stack.Children.Add(m_usernameEntry);
			...
			stack.Children.Add(passwordLabel);
			...
			stack.Children.Add(m_passwordEntry);
			...
			stack.Children.Add(prefetchLabel);
			...
			stack.Children.Add(m_prefetchEntry);
			...
			stack.Children.Add(cacheSizeLabel);
			...
			stack.Children.Add(m_cacheSizeEntry);
			...
			stack.Children.Add(scrobbleStack);
			...
			stack.Children.Add(clearCacheButton);
