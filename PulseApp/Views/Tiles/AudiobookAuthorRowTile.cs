...
{
	public class AudiobookAuthorRowTile : PulseAppView
	{
		private ArtImage m_art;
		private Label m_nameLabel;
		private Label m_subtitleLabel;
		private AudiobookAuthor m_author;

		public AudiobookAuthorRowTile() : base(MainView.Self)
		{
		...
		protected override void OnBindingContextChanged()
		{
			...
			AudiobookAuthor author = BindingContext as AudiobookAuthor;
			if (author == null)
			{
				return;
			}
			m_author = author;
			m_nameLabel.Text = author.Name;
			string suffix = " books";
			if (author.BookCount == 1)
			{
				suffix = " book";
			}
			m_subtitleLabel.Text = author.BookCount + suffix;
			m_art.SetCoverArt(author.CoverArt);
		}
		...
		private void OnTapped(object sender, EventArgs e)
		{
			...
			m_mainView.OnAudiobookAuthorSelected(m_author);
		}
	}
}
