...
A self-hosted music server built in C#. Scans a local library, serves it over the OpenSubsonic API, and layers on playlist sync, scoring, smart playlists, and a tablet web client. Runs as a single executable with no external service dependencies.
