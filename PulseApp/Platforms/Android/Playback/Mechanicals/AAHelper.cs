...
namespace PulseApp.Playback.AndroidOS
{
	...
	public class AAutoHelper
	{
		...
		{
			private PulseAppMediaLibraryService m_owner;
			private string m_parentId;
			private eAADirectory m_parent;
			private int m_page;
			private int m_pageSize;

			public LoadContainerFunc(PulseAppMediaLibraryService owner, eAADirectory parent, string parentId, int page, int pageSize)
			{
				m_owner = owner;
				m_parentId = parentId;
				m_parent = parent;
		...
		public class LoadObjectFunc : Java.Lang.Object, CallbackToFutureAdapter.IResolver
		{
			...
			public LoadObjectFunc(PulseAppMediaLibraryService owner, eAAObject aaObject, string parentId, int page, int pageSize)
			{
				m_owner = owner;
				m_parentId = parentId;
				m_object = aaObject;
		...
		public class LoadMediaSetFunc : Java.Lang.Object, CallbackToFutureAdapter.IResolver
		{
			...
			public LoadMediaSetFunc(PulseAppMediaLibraryService owner, IList<MediaItem> items, int startIndex, long startPositionMs)
			{
				m_owner = owner;
				m_items = items;
