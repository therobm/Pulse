...
namespace PulseApp.Pulse
{
	...
	// in the future) must implement. Consumers (PulseAppData, MainView, the playback
	...
	public abstract class MediaClient
	{
		...
		public abstract void GenerateQueue(string mode, Action<PulsePlaylistDetails> onComplete);
