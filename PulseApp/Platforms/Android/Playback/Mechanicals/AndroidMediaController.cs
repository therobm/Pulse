...
{
	/// <summary>
	/// The minimum boundary between PulseApp code and the running Media3 session.
	/// Nothing on this class's surface knows about PulseTrack, MainView,
	/// PulseAppData, or any other PulseApp concept — every method takes / returns
	/// Media3 types or primitives. Whoever owns an instance is responsible for
	/// building MediaItems, maintaining any parallel PulseApp-side queue, and
	...
	public class AndroidMediaController
	{
		...
		/// <paramref name="serviceType"/> (e.g. typeof(PulseAppPlaybackService)).
