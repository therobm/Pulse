...
{
	public class NowPlayingView : PulseAppView
	{
		...
		private View BuildTitle()
		{
			...
			m_albumLabel.TextColor = PulseAppColors.TextSecondary;
			...
			m_artistLabel.TextColor = PulseAppColors.TextDim;
		...
		private View BuildSeekBar()
		{
			...
			m_currentTimeLabel.TextColor = PulseAppColors.TextDim;
			...
			m_seekSlider.MinimumTrackColor = PulseAppColors.Accent;
			m_seekSlider.MaximumTrackColor = PulseAppColors.Divider;
			m_seekSlider.ThumbColor = PulseAppColors.Accent;
			...
			m_totalTimeLabel.TextColor = PulseAppColors.TextDim;
		...
		private View BuildTransport()
		{
			...
			m_shuffleButton.TextColor = PulseAppColors.TextSecondary;
			...
			m_repeatButton.TextColor = PulseAppColors.TextSecondary;
		...
		private View BuildActions()
		{
			...
			m_favoriteButton.TextColor = PulseAppColors.TextSecondary;
			...
			queueButton.TextColor = PulseAppColors.TextSecondary;
			...
			m_sleepTimerButton.TextColor = PulseAppColors.TextSecondary;
		...
		private void UpdateFavoriteButton()
		{
			...
			{
				m_favoriteButton.Text = "♥  Favorite";
				m_favoriteButton.TextColor = PulseAppColors.Accent;
			}
			else
			{
				m_favoriteButton.Text = "♡  Favorite";
		...
		public void SetShuffleState(bool enabled)
		{
			...
			if (enabled)
			{
				m_shuffleButton.TextColor = PulseAppColors.Accent;
			}
			else
			{
				m_shuffleButton.TextColor = PulseAppColors.TextSecondary;
		...
		public void SetRepeatState(eRepeatMode mode)
		{
			...
			{
				m_repeatButton.Text = "↻¹";
				m_repeatButton.TextColor = PulseAppColors.Accent;
			}
		...
		public void SetSleepTimerDisplay(bool active, int remainingSeconds)
		{
			...
			if (active)
			{
				...
				m_sleepTimerButton.TextColor = PulseAppColors.Accent;
			}
			else
			{
				m_sleepTimerButton.Text = "⏲  Sleep";
