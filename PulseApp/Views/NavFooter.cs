...
{
	public class NavFooter : PulseAppView
	{
		...
		private View BuildHomeTab()
		{
			...
			m_homeIcon.Text = "\uE88A";
			m_homeIcon.TextColor = PulseAppColors.TextDim;
			...
			m_homeLabel.TextColor = PulseAppColors.TextDim;
		...
		private View BuildLibraryTab()
		{
			...
			m_libraryIcon.Text = "\uE030";
			m_libraryIcon.TextColor = PulseAppColors.TextDim;
			...
			m_libraryLabel.TextColor = PulseAppColors.TextDim;
		...
		private View BuildSearchTab()
		{
			...
			m_searchIcon.Text = "\uE8B6";
			m_searchIcon.TextColor = PulseAppColors.TextDim;
			...
			m_searchLabel.TextColor = PulseAppColors.TextDim;
		...
		private View BuildSettingsTab()
		{
			...
			m_settingsIcon.Text = "\uE8B8";
			m_settingsIcon.TextColor = PulseAppColors.TextDim;
			...
			m_settingsLabel.TextColor = PulseAppColors.TextDim;
		...
		public void SetActiveTab(eTab tab)
		{
			...
			if (tab == eTab.Home)
			{
				m_homeIcon.TextColor = PulseAppColors.OnBackground;
				m_homeLabel.TextColor = PulseAppColors.OnBackground;
			}
			else if (tab == eTab.Library)
			{
				m_libraryIcon.TextColor = PulseAppColors.OnBackground;
				m_libraryLabel.TextColor = PulseAppColors.OnBackground;
			}
			else if (tab == eTab.Search)
			{
				m_searchIcon.TextColor = PulseAppColors.OnBackground;
				m_searchLabel.TextColor = PulseAppColors.OnBackground;
			}
			else if (tab == eTab.Settings)
			{
				m_settingsIcon.TextColor = PulseAppColors.OnBackground;
				m_settingsLabel.TextColor = PulseAppColors.OnBackground;
			}
		}
