...
{
	public class TrackRowTile : PulseAppView
	{
		...
		private View BuildDuration()
		{
			...
			m_durationLabel.TextColor = PulseAppColors.TextDim;
		...
		private View BuildCacheIcon()
		{
			...
			m_cacheIcon.TextColor = PulseAppColors.Accent;
		...
		private View BuildOptions()
		{
			...
			optionsButton.TextColor = PulseAppColors.TextSecondary;
