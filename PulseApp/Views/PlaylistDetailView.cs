...
{
	public class PlaylistDetailView : PulseAppView
	{
		...
		private View BuildButtons()
		{
			...
			queueButton.TextColor = PulseAppColors.OnBackground;
			queueButton.BackgroundColor = PulseAppColors.Surface;
			...
			nextButton.TextColor = PulseAppColors.OnBackground;
			nextButton.BackgroundColor = PulseAppColors.Surface;
