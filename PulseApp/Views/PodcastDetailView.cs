...
{
	public class PodcastDetailView : PulseAppView
	{
		...
		private View BuildSettings()
		{
			...
			heading.FontSize = 12;
			heading.TextColor = PulseAppColors.TextDim;
			...
			m_retentionPicker.TextColor = PulseAppColors.OnBackground;
			m_retentionPicker.TitleColor = PulseAppColors.TextDim;
			...
			m_retentionValueEntry.TextColor = PulseAppColors.OnBackground;
			m_retentionValueEntry.PlaceholderColor = PulseAppColors.TextDim;
			...
			saveButton.TextColor = PulseAppColors.OnBackground;
			saveButton.BackgroundColor = PulseAppColors.Surface;
			...
			m_settingsStatusLabel.TextColor = PulseAppColors.TextDim;
